...
//argument[0]: Interference
//argument[1]: Combination
                ...
                if(Hold == (-1) || Hold == obj_Player.Index)
                {
                    ...
                    //{
                        ...
                        else if(Selected == true)
                        {
                            ...
                            else if(argument[1] == 1) //Card
                            {
                                if(place_meeting(x,y,obj_Deck) == true)
                                {
                                    with(obj_Deck)
                                    {
                                        if(place_meeting(x,y,other))
                                        {
                                            ds_list_insert(ListIndex,0,other.MasterIndex);
                                        }
                                    }
                                    instance_destroy();
                                }
                            }
                            else if(argument[1] == 2) //Deck
                            {
                                if(place_meeting(x,y,obj_Card) == true)
                                {
