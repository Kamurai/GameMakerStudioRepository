   switch (readbyte())
    {
        case movement:
            ...
            with(obj_player) {
                if(id!=iD) {
                    clearbuffer();
                    if(isPlayer) writebyte(movement); else writebyte(specmovement);
                    writestring(piece);
                    if(!isPlayer) {
            ...
            for(i=0;i<instance_number(obj_pawn);i+=1)
                ...
                if(instance_find(obj_pawn,i).image_single=myImageSingle) {
                        with(instance_find(obj_pawn,i)) {
                            ...
                            if(collision_point(x,y,obj_pawn,0,1)) with(collision_point(x,y,obj_pawn,0,1)) instance_destroy();
                            if(collision_point(x,y,obj_knight,0,1)) with(collision_point(x,y,obj_knight,0,1)) instance_destroy();
                            if(collision_point(x,y,obj_rook,0,1)) with(collision_point(x,y,obj_rook,0,1)) instance_destroy();
                            if(collision_point(x,y,obj_bishop,0,1)) with(collision_point(x,y,obj_bishop,0,1)) instance_destroy();
                            if(collision_point(x,y,obj_queen,0,1)) with(collision_point(x,y,obj_queen,0,1)) instance_destroy();
                            if(collision_point(x,y,obj_king,0,1)) with(collision_point(x,y,obj_king,0,1)) instance_destroy();
                        } 
                    }
                }
            }
        ...
        case leave:
            if(isPlayer) global.chessReplayRequests=0;
            instance_destroy();
            break;
