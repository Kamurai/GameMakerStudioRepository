...
it to 0 to use the default buffer.
*/
return external_call(global._BufM, 0);//argument0);
#define closesocket
/*
...
it to 0 to use the default buffer.
*/
return external_call(global._BufL, 0);//argument0);
#define readfloat
/*
...
it to 0 to use the default buffer.
*/
return external_call(global._BufK, 0);//argument0);
#define readint
/*
...
it to 0 to use the default buffer.
*/
return external_call(global._BufJ, 0);//argument0);
#define readsep
/*
...
*/
return external_call(global._BufAG, argument0, 0);//argument1);
#define readshort
/*
...
return external_call(global._SokD, obj_Connection.server_listening_socket, "", obj_Connection.server_port, 0);
#define setformat
/*
...
it to 0 to use the default buffer.
*/
return external_call(global._BufA, argument0, 0); //argument1);
#define writechars
/*
...
it to 0 to use the default buffer.
*/
return external_call(global._BufR, argument0, 0);//argument1);
#define writedouble
/*
...
it to 0 to use the default buffer.
*/
return external_call(global._BufF, argument0, 0);//argument1);
#define writefloat
/*
...
it to 0 to use the default buffer.
*/
return external_call(global._BufE, argument0, 0);//argument1);
#define writeint
/*
...
it to 0 to use the default buffer.
*/
return external_call(global._BufD, argument0, 0);//argument1);
#define writeshort
/*
...
it to 0 to use the default buffer.
*/
return external_call(global._BufC, argument0, 0);//argument1);
#define writestring
/*
...
it to 0 to use the default buffer.
*/
return external_call(global._BufB, argument0, 0); //argument1);
#define writeuint
/*
